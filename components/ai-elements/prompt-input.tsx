    ...
    <PromptInputHoverCard>
      <HoverCardTrigger
        render={
          <div
            className={cn(
              "group relative flex items-center gap-1.5 hover:bg-accent dark:hover:bg-accent/50 px-1.5 border border-border rounded-md h-8 font-medium text-sm transition-all hover:text-accent-foreground cursor-pointer select-none",
              className,
            )}
            key={data.id}
            {...props}
...
export const PromptInputSpeechButton = ({
  ...
  }, [textareaRef, onTranscriptionChange, isSupported]);
